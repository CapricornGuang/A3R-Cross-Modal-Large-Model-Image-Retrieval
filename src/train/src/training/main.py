...
def main(args):
    ...
    preprocess_train = T.Compose([T.Lambda(square_padding)]+preprocess_train.transforms)
    preprocess_val = T.Compose([T.Lambda(square_padding)]+preprocess_val.transforms)
    ...
    if is_master(args):
        ...
        logging.info(f"preprocess_train: {str(preprocess_train)}")
        logging.info(f"preprocess_val: {str(preprocess_val)}")
